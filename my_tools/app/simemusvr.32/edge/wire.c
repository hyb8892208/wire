                   ...
                   const n2n_common_t * common )
{
    ...
    encode_buf( base, idx, common->password, N2N_PASSWORD_SIZE );
    encode_buf( base, idx, common->private_ip, N2N_PRIVATEIP_SIZE );
    return -1;
}
                   ...
                   size_t * idx )
{
	...
	decode_buf(out->password,N2N_PASSWORD_SIZE,base,rem,idx);
	decode_buf(out->private_ip,N2N_PRIVATEIP_SIZE,base,rem,idx);
