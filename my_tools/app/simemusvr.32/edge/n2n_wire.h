...
#define N2N_PASSWORD_SIZE				16
#define N2N_PRIVATEIP_SIZE				16
...
typedef uint8_t n2n_password_t[N2N_PASSWORD_SIZE];
typedef uint8_t n2n_privateip_t[N2N_PASSWORD_SIZE];
