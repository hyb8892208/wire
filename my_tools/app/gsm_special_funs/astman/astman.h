...
#define MAX_LEN         ((MAX_NAME_LEN)+(MAX_VALUE_LEN))
 ...
 /*******************************************************************************
  *  @def    
  *  @brief astman return value
  ******************************************************************************/
#define ASTMAN_FAILURE		-1
#define ASTMAN_SOCKCLOSED	 0
#define ASTMAN_SUCCESS		 1
#define ASTMAN_TIMEOUT		 2
...
/*******************************************************************************
 *  \fn int astman_wait_for_response(struct mansession *s, struct message *msg, NULL, time_t timeout)
 *  \brief
 *  \return
 ******************************************************************************/
