<!-- The page of Summary -->
<div class="ant-card-body" data-for="six-page" style="padding: 20px;display:none">
<div class="ant-row">
  ...
  <div class="ant-row ant-form-item">
    ...
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control has-success">
        <select id="s_lan_type" name="s_lan_type" onchange="LanTypeChange()" class="ant-select-selection-selected-value">
  ...
  <div class="ant-row ant-form-item">
    ...
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control has-success">
        <input type="text" value="" id="s_lan_ip_address" data-__meta="[object Object]" class="ant-input ant-input-lg">
      </div>
    </div>
  </div>
  <div class="ant-row ant-form-item">
    ...
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control has-success">
        <input type="text" value="" id="s_lan_netmask" data-__meta="[object Object]" class="ant-input ant-input-lg">
      </div>
    </div>
  </div>
  <div class="ant-row ant-form-item">
    ...
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control has-success">
        <input type="text" value="" id="s_lan_gateway" data-__meta="[object Object]" class="ant-input ant-input-lg">
      </div>
    </div>
  </div>
  <div id="sdns">
  <div class="ant-row ant-form-item">
    ...
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control ">
        <input type="text" value="" id="s_lan_dns1" data-__meta="[object Object]" class="ant-input ant-input-lg">
      </div>
    </div>
  </div>
  <div class="ant-row ant-form-item">
    ...
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control ">
        <input type="text" value="" id="s_lan_dns2" data-__meta="[object Object]" class="ant-input ant-input-lg">
      </div>
    </div>
  </div>
  <div class="ant-row ant-form-item">
    ...
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control ">
        <input type="text" value="" id="s_lan_dns3" data-__meta="[object Object]" class="ant-input ant-input-lg">
      </div>
    </div>
  </div>
  </div>
  <div class="ant-row">
    <div class="ant-col-24">
      <div class="section-title"><span>WAN</span></div>
    </div>
  </div>
  <div class="ant-row ant-form-item">
    <div class="ant-col-4 ant-form-item-label">
      <label for="wan_ip_method" class="" title=""><span><?php echo language('IP Method');?></span></label>
    </div>
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control has-success">
        <select id="s_wan_type" name="s_wan_type" onchange="LanTypeChange()" class="ant-select-selection-selected-value ">
          <option  value="dhcp" <?php echo $type['dhcp'];?> ><?php echo language('DHCP');?></option>
          <!-- <option  value="factory" <?php echo $type['factory'];?> ><?php echo language('Factory');?></option> -->
          <option  value="static" <?php echo $type['static'];?> ><?php echo language('Static');?></option>
  ...
  <div class="ant-row ant-form-item">
    <div class="ant-col-4 ant-form-item-label">
      <label for="wan_ip" class="" title=""><span><?php echo language('IP Address');?></span></label>
    </div>
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control has-success">
        <input type="text" value="" id="s_wan_ip_address" data-__meta="[object Object]" class="ant-input ant-input-lg">
      </div>
    </div>
  </div>
  <div class="ant-row ant-form-item">
    <div class="ant-col-4 ant-form-item-label">
      <label for="wan_netmask" class="" title=""><span><?php echo language('Subnet Mask');?></span></label>
    </div>
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control has-success">
        <input type="text" value="" id="s_wan_netmask" data-__meta="[object Object]" class="ant-input ant-input-lg">
      </div>
    </div>
  </div>
  <div class="ant-row ant-form-item ">
    <div class="ant-col-4 ant-form-item-label">
      <label for="wan_gateway" class="" title=""><span><?php echo language('Gateway IP');?></span></label>
    </div>
    <div class="ant-col-6 ant-form-item-control-wrapper">
      <div class="ant-form-item-control has-success">
        <input type="text" value="" id="s_wan_gateway" data-__meta="[object Object]" class="ant-input ant-input-lg">
      </div>
    </div>
  </div>
  </div>
  <div class="ant-row">
    <div class="ant-col-24">
      <div class="section-title"><span><?php echo language('Time Zone');?></span></div>
    </div>
   <div class="ant-row ant-form-item">
		<div class="ant-col-4 ant-form-item-label"
		...
		<div class="ant-col-6 ant-form-item-control-wrapper">
			<div class="ant-form-item-control has-success">
				<select id="s_system_timezone" name="s_system_timezone" onchange="modechange(this)" class="ant-select-selection-selected-value">
	...
	<div class="ant-row ant-form-item">
		...
		<div class="ant-col-6 ant-form-item-control-wrapper">
			<div class="ant-form-item-control has-success">
				<input type="text" value="" id="s_self_defined_time_zone" data-__meta="[object Object]" class="ant-input ant-input-lg">
			</div>
		</div>
	</div>
	<div class="ant-row ant-form-item">
		...
		<div class="ant-col-6 ant-form-item-control-wrapper">
			<div class="ant-form-item-control has-success">
				<select id="s_language_type" class="ant-select-selection-selected-value">
							...
							<div class="ant-table-content">
								<div class="ant-table-body">
									...
									<thead class="ant-table-thead">
										<tr>
											<th class="">
												<span><!-- react-text: 3095 --><?php echo language('Endpoint Name');?><!-- /react-text --></span>
											</th>
											<th class="">
												<span><!-- react-text: 3096 --><?php echo language('Registration');?><!-- /react-text --></span>
											</th>
											<th class="">
												<span><!-- react-text: 3097 --><?php echo language('Credentails');?><!-- /react-text --></span>
											</th>
										</tr>
									</thead>
									<tbody id="s_tab_sipendpoints" class="ant-table-tbody">
										<tr class="ant-table-row  ant-table-row-level-0">
											<td class="">
												<span class="ant-table-row-indent indent-level-0" style="padding-left: 0px;"></span><!-- react-empty: 3104 --><!-- react-text: 3105 -->unix<!-- /react-text -->
											</td>
											<td class=""><!-- react-text: 3107 -->2<!-- /react-text --></td>
											<td class=""><!-- react-text: 3109 -->[ACC]<!-- /react-text --></td>
										</tr>
									</tbody>
									</table>
								</div>
							...
							<div class="ant-table-content">
								<div class="ant-table-body">
									...
									<thead class="ant-table-thead">
										<tr>
											<th class="">
												<span><!-- react-text: 3095 --><?php echo language('Group Name');?><!-- /react-text --></span>
											</th>
											<th class="">
												<span><!-- react-text: 3096 --><?php echo language('Policy');?><!-- /react-text --></span>
											</th>
											<th class="">
												<span><!-- react-text: 3097 --><?php echo language('Members');?><!-- /react-text --></span>
											</th>
										</tr>
									</thead>
									<tbody id="s_tab_groups" class="ant-table-tbody">
										<tr class="ant-table-row  ant-table-row-level-0">
											<td class="">
												<span class="ant-table-row-indent indent-level-0" style="padding-left: 0px;"></span><!-- react-empty: 3104 --><!-- react-text: 3105 -->unix<!-- /react-text -->
											</td>
							...
							<div class="ant-table-content">
								<div class="ant-table-body">
									...
									<thead class="ant-table-thead">
										<tr>
											<th class="">
												<span><!-- react-text: 3095 --><?php echo language('Order');?><!-- /react-text --></span>
											</th>
											<th class="">
												<span><!-- react-text: 3096 --><?php echo language('Rule Name');?><!-- /react-text --></span>
											</th>
											<th class="">
												<span><!-- react-text: 3097 --><?php echo language('From');?><!-- /react-text --></span>
											</th>
											<th class="">
												<span><!-- react-text: 3097 --><?php echo language('To');?><!-- /react-text --></span>
											</th>
											<th class="">
												<span><!-- react-text: 3097 --><?php echo language('Rules');?><!-- /react-text --></span>
											</th>
										</tr>
									</thead>
									<tbody id="s_tab_routings_out" class="ant-table-tbody">
										<tr class="ant-table-row  ant-table-row-level-0">
											<td class="">
												<span class="ant-table-row-indent indent-level-0" style="padding-left: 0px;"></span><!-- react-empty: 3104 --><!-- react-text: 3105 -->unix<!-- /react-text -->
											</td>
											<td class=""><!-- react-text: 3107 --><!-- /react-text --></td>
											<td class=""><!-- react-text: 3109 --><!-- /react-text --></td>
											<td class=""><!-- react-text: 3109 --><!-- /react-text --></td>
											<td class=""><!-- react-text: 3109 --> <!-- /react-text --></td>
										</tr>
									</tbody>
									  <tbody id="s_tab_routings_in" class="ant-table-tbody hidden">
										<tr class="ant-table-row  ant-table-row-level-0">
										  <td class="">
											<span class="ant-table-row-indent indent-level-0" style="padding-left: 0px;"></span><!-- react-empty: 3104 --><!-- react-text: 3105 -->unix<!-- /react-text -->
										  </td>
