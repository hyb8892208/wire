			...
			if (isset($_POST['vpn_type'])) {
				...
				switch($type) {
					case 'openvpn': 
						...
						save_user_record("","NETWORK->VPN Settings:OPENVPN Save");
						break;
					...
					case 'pptpvpn': 
						...
						save_user_record("","NETWORK->VPN Settings:PPTPVPN Save");
						break;
						
					case 'n2nvpn':
						save_n2nvpn();
						
						save_user_record("","NETWORK->VPN Settings:N2NVPN Save");
						break;
					...
					case 'l2tpvpn':
						...
						save_user_record("","NETWORK->VPN Settings:L2TPVPN Save");
						break;
					...
					case 'nonevpn': 
						...
						save_user_record("","NETWORK->VPN Settings:nonevpn Save");
						break;
...
<form enctype="multipart/form-data" action="<?php echo get_self(); ?>" method="post">
	...
	<div class="content">
		<span class="title">
			<?php echo language('VPN Settings');?>
			
			<?php if(is_show_language_help('VPNType')){ ?>
				<div class="tip_main">
					...
					<div class="tip_help">
						...
						<div class="tip_content">
							<b><?php echo language('VPNType');?>:</b><br/>
							<?php echo language('VPNType help','
								The type of VPN.<br/>
								OpenVPN: openvpn.<br/>
		...
		<div class="tab_item div_openvpn">
			<span>
				...
				<div class="tip_main">
					...
					<div class="tip_help">
						...
						<div class="tip_content">
							<b><?php echo language('VPN detection');?>:</b><br/>
	...
	<div class="content div_openvpn" style="display:none;">
		<span class="title"><?php echo language('OpenVPN Settings');?></span>
		
		<table width="100%" class="tctl">
			<tr id="tr_upload_conf">
				<th style="background:#ECFFEF;">
		...
		<table width="100%" class="tctl">
			<tr>
				<th style="background:#ECFFEF;">
					<textarea name="helpinfo" id="helpinfo" style="width:100%;font-size:12px;Line-height:1.5;background:#ECFFEF;border:none" clos="20" rows="5" readonly>
						   <?php echo language('OpenVPN Configuration Files help'); ?>
					</textarea>
				</th>
				<td width="1px" style="background:#ECFFEF;">
				</td>
			</tr>
		</table>
		<table width="100%" class="tctl">
		...
		<table class="tedit" width="100%">
			<tr>
				<th style="background:#38AD6F;">
					<div class="helptooltips">
						<span style="color:red">* &nbsp;</span><?php echo language('Connection Status');?>:
					</div>
				</th>
				<td class="openvpn_connect" style="background:#ECFFEF;">
	...
	<div id="div_n2nvpn" style="display:none" class="content">
		<span class="title">
			<?php echo language('N2N VPN Settings');?>
			...
			<div class="tip_main">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						...
						<?php if(is_show_language_help('Local IP')){ ?>
							<b><?php echo language('Local IP');?>:</b><br/>
							<?php echo language('Local IP help','Local IP');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Subnet Mask')){ ?>
							<b><?php echo language('Subnet Mask');?>:</b><br/>
							<?php echo language('Subnet Mask help','Subnet Mask');?>
						...
						<?php if(is_show_language_help('User Name')){ ?>
							...
							<?php echo language('User Name help','User Name');?>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span><input type="checkbox" name="n2n_enable" id="n2n_enable" <?php echo $n2n_enable?> /></span>
			</div>
		</div>
		...
		<div id="n2n_show_status" class="tab_item" <?php if($exist_array['n2n']['enable'] != 'on'){ echo 'style="display:none;"';}?>>
			<span>
				<span style="color:red">* &nbsp;</span><?php echo language('Connection Status');?>:
			</span>
			<div class="tab_item_right">
				<table>
					<td class="n2n_connect"></td>
				</table>
			</div>
		</div>
	</div>

	<div class="content" id="div_pptpvpn_tab" style="list-style-type:none">
		<span class="title">
			<?php echo language('PPTP VPN Settings');?>

			<?php if(is_show_language_help('Server')){ ?>
				<div class="tip_main">
					<img class="tip_img" src="/images/tip.png" style="cursor:pointer;" />
					<div class="tip_help">
						<i class="top" ></i>
						...
						<div class="tip_content">
							<?php if(is_show_language_help('Server')){ ?>
								<b><?php echo language('Server');?>:</b><br/>
								<?php echo language('Server help',"Server ip address.");?>
							...
							<?php if(is_show_language_help('Account')){ ?>
								...
								<?php echo language('Account help',"pptp vpn account");?>
							...
							<?php if(is_show_language_help('Password')){ ?>
								<b><?php echo language('Password');?>:</b><br/>
								<?php echo language('Password help',"VPN password");?>
								
								<br/><br/>
							<?php } ?>
							
							<?php if(is_show_language_help('Use MPPE')){ ?>
								<b><?php echo language('Use MPPE', "Use MPPE");?>:</b><br/>
								<?php echo language('Use MPPE help',"Use MPPE or not");?>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span><input type="checkbox" id="pptp_mppe" name="pptp_mppe" <?php if($mppe){echo 'checked';}?>/></span>
			</div>
		</div>
	...
	<div class="content" id="div_l2tpvpn_tab" style="list-style-type:none">
		<span class="title">
			<?php echo language('L2TP VPN Settings');?>
			<div class="tip_main">
				<img class="tip_img" src="/images/tip.png" style="cursor:pointer;" />
				<div class="tip_help">
					<i class="top" ></i>
					...
					<div class="tip_content">
						...
						<?php if(is_show_language_help('IPSec')){ ?>
							<b><?php echo language('IPSec');?>:</b><br/>
						...
						<!--
						<?php if(is_show_language_help('IPsec Local IP Address')){ ?>
							<b><?php echo language('IPsec Local IP Address');?>:</b><br/>
							<?php echo language('IPsec Local IP Address help',"IPsec Local IP Address");?>
							
							<br/><br/>
						<?php } ?>
						-->
						
						<?php if(is_show_language_help('IPSec Password')){ ?>
							<b><?php echo language('IPSec Password');?>:</b><br/>
						...
						<!--
						<?php if(is_show_language_help('IPsec Remote Network')){ ?>
							<b><?php echo language('IPsec Remote Network');?>:</b><br/>
							<?php echo language('IPsec Remote Network help',"IPsec Remote Network");?>
						...
						<?php if(is_show_language_help('Default Gateway')){ ?>
							...
							<?php echo language('Default Gateway help',"Default Gateway");?>
		...
		<div class="tab_item">
			<span>
				<?php echo language('IPsec Local IP Address');?>:
			</span>
			<div class="tab_item_right">	
				<input type="text" name="IPSec_IP" id="IPSec_IP" value="<?php echo $IPSec_IP; ?>" />
			</div>
		</div>
		-->
		...
		<div class="tab_item">
			<span>
				<?php echo language('IPSec Remote Network');?>:
			</span>
			<div class="tab_item_right">	
				<input type="text" name="IPSec_remote_IP" id="IPSec_remote_IP" value="<?php echo $IPSec_remote_IP; ?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">	
				<input type="checkbox" name="default_gateway" id="default_gateway" <?php echo $default_gateway; ?> />
			</div>
		</div>
		-->
	...
	<div id="button_save">
		<?php if(!$only_view){ ?>
		<input type="submit" value="<?php echo language('Save');?>" style="margin-top:10px;float:right;" onclick="document.getElementById('send').value='Save';" <?php if($__demo_enable__=='on'){echo 'disabled';}?> />
		<?php } ?>
	</div>
</form>
