...
function check()
{
	...
	if(mail_sw) {
		...
		if(!check_domain(smtpserver)) {
			document.getElementById('smtpserver').focus();
		...
		if(smail1 == '' && smail2 == '' && smail3 == '') {
			document.getElementById('smail1').focus();
		...
		if(smail2 != '') {
			if(!check_email(smail2)) {
				document.getElementById('smail2').focus();
		...
		if(smail3 != '') {
			if(!check_email(smail3)) {
				document.getElementById('smail3').focus();
	...
	if(ctl_sw) {
		if(!check_diypwd(ctl_pwd)) {
			document.getElementById('ctl_pwd').focus();
	...
	if(http_sw) {
		...
		if(isNaN(http_timeout_total) || http_timeout_total <= 0) {
			document.getElementById('http_timeout_total').focus();
		...
		if(http_api_adv_enable) {
			...
			if(isNaN(http_debug) || http_debug < 0) {
				document.getElementById('http_debug').focus();
			...
			if(isNaN(http_timeout_wait) || http_timeout_wait <= 0) {
				document.getElementById('http_timeout_wait').focus();
			...
			if(isNaN(http_timeout_gsm_send) || http_timeout_gsm_send <= 0) {
				document.getElementById('http_timeout_gsm_send').focus();
			...
			if(isNaN(http_timeout_socket) || http_timeout_socket <= 0) {
				document.getElementById('http_timeout_socket').focus();
...
//	save_to_manager_conf();
	...
	save_user_record("","SMS->SMS Settings:Save");
...
<form enctype="multipart/form-data" action="<?php echo get_self() ?>" method="post">
	...
	<div class="content">
			...
			<div class="tip_main">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						<?php if(is_show_language_help('SMS Received')){ ?>
							<b><?php echo language('SMS Received');?>:</b><br/>
							<?php echo language('SMS Received help','ON(enabled),OFF(disabled)');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('SMS Local Stored')){ ?>
							<b><?php echo language('SMS Local Stored');?>:</b><br/>
							<?php echo language('SMS Local Stored help','ON(enabled),OFF(disabled)');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('SMS Status Report')){ ?>
							<b><?php echo language('SMS Status Report');?>:</b><br/>
							<?php echo language('SMS Status Report help','ON(enabled),OFF(disabled)');?>
						<?php } ?>
					</div>
				</div>
			</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span><input type="checkbox" id="smsprocess" name="smsprocess" <?php echo $stored_sw ?> /></span>
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span><input type="checkbox" class="enable" name="sms_local_store_enable" <?php echo $sms_local_store_enable;?> /></span>
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span><input type="checkbox" id="smsreport" name="smsreport" <?php echo $receipt_sw ?> /></span>
			</div>
		</div>
	</div>
	...
	<div class="content">
		<span class="title">
			<?php echo language('Sender Options');?>
			...
			<div class="tip_main">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						<?php if(is_show_language_help('Resend Failed Message')){ ?>
							<b><?php echo language('Resend Failed Message');?>:</b><br/>
							<?php echo language('Resend Failed Message help','The times that you will attempt to resend your failed message.');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Repeat Same Message')){ ?>
							<b><?php echo language('Repeat Same Message');?>:</b><br/>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<select size=1 name="send_attempt">
					<option value="-1" <?php echo $send_attempt['-1']?> > <?php echo language('always');?> </option>
	...
	<div class="content">
		<span class="title">
			...
			<div class="tip_main">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						<?php if(is_show_language_help('SMS to Email')){ ?>
							<b><?php echo language('SMS to Email');?>:</b><br/>
						...
						<?php if(is_show_language_help('SMTP Server')){ ?>
							<b><?php echo language('SMTP Server');?>:</b><br/>
							<?php echo language('SMTP Server help','SMTP Server');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Email Address of Sender')){ ?>
							<b><?php echo language('Email Address of Sender');?>:</b><br/>
						...
						<?php if(is_show_language_help('Domain')){ ?>
							<b><?php echo language('Domain');?>:</b><br/>
							<?php echo language('Domain help','To set outgoing mail server. <br/> e.g. mail.openvox.cn');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('SMTP Port')){ ?>
							<b><?php echo language('SMTP Port');?>(<?php echo language('default');?> 25):</b><br/>
							<?php echo language('SMTP Port help','To set port number of outgoing mail server. (Default is 25.)');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('SMTP User Name')){ ?>
							<b><?php echo language('SMTP User Name');?>:</b><br/>
							<?php
						...
						<?php if(is_show_language_help('SMTP Password')){ ?>
							<b><?php echo language('SMTP Password');?>:</b><br/>
							<?php echo language('SMTP Password help','The password to login your existing email.');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('TLS Enable')){ ?>
							<b><?php echo language('TLS Enable');?>:</b><br/>
							<?php echo language('TLS Enable help');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Title')){ ?>
							<b><?php echo language('Title');?>:</b><br/>
						...
						<?php if(is_show_language_help('Content')){ ?>
							<b><?php echo language('Content');?>:</b><br/>
						...
						<?php if(is_show_language_help('Test')){ ?>
							<b><?php echo language('Test');?>:</b><br/>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span><input type="checkbox" id="mail_sw" name="mail_sw" <?php echo $mail_sw ?> onchange="mail_change(this.checked)" /></span>
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span id="csmtpserver"></span>
				<input type="text" name="smtpserver" id="smtpserver" value="<?php echo $smtpserver;?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span id="csmtpport"></span>
				<input type="text" name="smtpport" id="smtpport" value="<?php echo $smtpport;?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span id="csmtpuser"></span>
				<input type="text" name="smtpuser" id="smtpuser" value="<?php echo $smtpuser;?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				...
				<input type="password" name="smtppwd" id="smtppwd" value="<?php echo $smtppwd;?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span id="csmail1"></span>
				<input type="text" name="smail1" id="smail1" value="<?php echo $smail1;?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span id="csmail2"></span>
				<input type="text" name="smail2" id="smail2"  value="<?php echo $smail2;?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span id="csmail3"></span>
				<input type="text" name="smail3" id="smail3" value="<?php echo $smail3;?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span id="cmail_title"></span>
				<input type="text" name="mail_title" id="mail_title" value="<?php echo $mail_title;?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span id="cmail_content"></span>
				<input type="text" name="mail_content" id="mail_content" value="<?php echo $mail_content;?>" />
			</div>
		</div>
		...
		<span class="title">
			...
			<div class="tip_main">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						<b><?php echo language('SMS to Email').'--'.language("Destination Email Address");?>:</b><br/>
	...
	<div class="content">
		<span class="title">
			...
			<div class="tip_main">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						<?php if(is_show_language_help('SMS Control')){ ?>
							<b><?php echo language('SMS Control');?>:</b><br/>
						...
						<?php if(is_show_language_help('Password')){ ?>
							...
							<?php echo language('Password help', "The password to confirm that SMS makes the gateway rebooted, shut down, <br/>
						...
						<?php if(is_show_language_help('SMS Formats')){ ?>
							<b><?php echo language('SMS Formats');?>:</b><br/>
						...
						<?php if(is_show_language_help('SMS Inbox Auto clean')){ ?>
							<b><?php echo language('SMS Inbox Auto clean');?>:</b><br/>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span><input type="checkbox" id="ctl_sw" class="checkbox" name="ctl_sw" <?php echo $ctl_sw ?> onchange="ctl_change(this.checked)"/></span>
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				...
				<input type="text" name="ctl_pwd" id="ctl_pwd" value="<?php echo $ctl_pwd;?>" />
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right" style="font-weight:bold;">
				...
				?>
				<?php }else{ ?>
				<?php echo language('SMS Formats contents for Custom','
					reboot system PASSWORD<br><br>
					restore config PASSWORD<br><br>
					get info PASSWORD');
				?>
	...
	<div class="content">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						...
						<?php if(is_show_language_help('Report')){ ?>
							...
							<?php echo language('Report help', 'SMS send result Report');?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Advanced')){ ?>
							<b><?php echo language('Advanced');?>:</b><br/>
						...
						<?php if(is_show_language_help('HTTP to SMS Timeout')){ ?>
							<b><?php echo language('Timeout');?>:</b><br/>
							<?php echo language('Timeout help', 'HTTP to SMS Timeout Timeout.<br/>Unit: seconds.'); ?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Wait Timeout')){ ?>
							<b><?php echo language('Wait Timeout');?>:</b><br/>
							<?php echo language('Wait Timeout help', 'Unit: seconds.'); ?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('GSM Send Timeout')){ ?>
							<b><?php echo language('GSM Send Timeout');?>:</b><br/>
							<?php echo language('GSM Send Timeout help', 'Unit: seconds.'); ?>

							<br/><br/>
						<?php } ?>

						<?php if(is_show_language_help('Socket Timeout')){ ?>
							<b><?php echo language('Socket Timeout');?>:</b><br/>
							<?php echo language('Socket Timeout help', 'Unit: seconds'); ?>
						<?php } ?>
					</div>
				</div>
			</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				...
				<button class="button_show_help" type="button" id="http_to_sms_help" title="Usage of HTTP to SMS">
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				<span><input type="checkbox" id="http_api_adv_enable" name="http_api_adv_enable" onchange="http_change_adv(this,'http_api_adv')" /></span>
			</div>
		</div>
		...
		<div class="tab_item">
			<span>
				<?php echo language('Wait Timeout');?>:
			</span>
			<div class="tab_item_right">
		...
		<div class="tab_item">
			<span>
				<?php echo language('GSM Send Timeout');?>:
			</span>
			<div class="tab_item_right">
		...
		<div class="tab_item">
			<span>
				<?php echo language('Socket Timeout');?>:
			</span>
			<div class="tab_item_right">
	...
	<div class="content">
			...
			<div class="tip_main">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						...
						<?php if(is_show_language_help('Enable SMS Reports to HTTP')){ ?>
							<b><?php echo language('Enable SMS Reports to HTTP');?>:</b><br/>
							<?php echo language('Enable SMS Reports to HTTP help', "ON(enabled),OFF(disabled)");?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Enable AsyncSMS Result to HTTP')){ ?>
							<b><?php echo language('Enable AsyncSMS Result to HTTP');?>:</b><br/>
							<?php echo language('Enable AsyncSMS Result to HTTP help', "ON(enabled),OFF(disabled)");?>
						...
						<?php if(is_show_language_help('URL')){ ?>
							<b><?php echo language('URL');?>:</b><br/>
							<?php echo language('URL help', 'The SMS receive HTTP URL'); ?>
						<?php } ?>
					</div>
				</div>
			</div>
		...
		<div class="tab_item">
			<span>
				<?php echo language('Enable SMS Reports to HTTP');?>:
			</span>
			<div class="tab_item_right">
				<span><input type="checkbox" id="sms_reports_sw" name="sms_reports_sw" <?php echo $sms_reports_sw ?> /></span>
			</div>
		</div>
		
		<div class="tab_item">
			<span>
				<?php echo language('Enable AsyncSMS Result to HTTP');?>:
			</span>
			<div class="tab_item_right">
				<span><input type="checkbox" id="sms_results_sw" name="sms_results_sw" <?php echo $sms_results_sw ?> /></span>
			</div>
		</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				...
				<select name="sms_url_http" id="sms_url_http" style="width:70px;">
					...
					://&nbsp;
				<input id="sms_url_host" type="text" name="sms_url_host" value="<?php echo $sms_url_host; ?>" style="width:78px;" 
					onfocus="_onfocus(this,'host')" onblur="_onblur(this,'host')" />:
				<input id="sms_url_port" type="text" name="sms_url_port" value="<?php echo $sms_url_port; ?>" style="width:28px;" 
					onfocus="_onfocus(this,'port')" onblur="_onblur(this,'port')" />/
				<input id="sms_url_path" type="text" name="sms_url_path" value="<?php echo $sms_url_path; ?>" style="width:78px;" 
					onfocus="_onfocus(this,'path')" onblur="_onblur(this,'path')" />?
				<input id="sms_url_from_num" type="text" name="sms_url_from_num" value="<?php echo $sms_url_from_num; ?>" style="width:38px;" 
					onfocus="_onfocus(this,'key')" onblur="_onblur(this,'key')" />
					=phonenumber&amp;
				<input id="sms_url_to_num" type="text" name="sms_url_to_num" value="<?php echo $sms_url_to_num; ?>" style="width:28px;" 
					onfocus="_onfocus(this,'key')" onblur="_onblur(this,'key')" />
					=port&amp;
				<input id="sms_url_portname" type="text" name="sms_url_portname" value="<?php echo $sms_url_portname; ?>" style="width:28px;" 	onfocus="_onfocus(this,'key')" onblur="_onblur(this,'key')" />
					=portname&amp;
				<input id="sms_url_message" type="text" name="sms_url_message" value="<?php echo $sms_url_message; ?>" style="width:38px;" 
					onfocus="_onfocus(this,'key')" onblur="_onblur(this,'key')" />
					=message&amp;
				<input id="sms_url_time" type="text" name="sms_url_time" value="<?php echo $sms_url_time; ?>" style="width:25px;" 
					onfocus="_onfocus(this,'key')" onblur="_onblur(this,'key')" />
					=time&amp;
					<input id="sms_url_imsi" type="text" name="sms_url_imsi" value="<?php echo $sms_url_imsi; ?>" style="width:50px;" 
						onfocus="_onfocus(this,'key')" onblur="_onblur(this,'key')" />
						=imsi&amp;
				<input id="sms_url_status" type="text" name="sms_url_status" value="<?php echo $sms_url_status; ?>" style="width:28px;" 
					onfocus="_onfocus(this,'key')" onblur="_onblur(this,'key')" />
					=status&amp;
				<input id="sms_url_user_defined" type="text" name="sms_url_user_defined" value="<?php echo $sms_url_user_defined; ?>" style="width:28px;" 
					onfocus="_onfocus(this,'User Defined')" onblur="_onblur(this,'User Defined')" />
				<span id="csms_url"></span>
				<button class="button_show_help" type="button" id="sms_to_http_help" title="Usage of SMS to HTTP">
					<img src="/images/help.png">
				</button>
			</div>
			<div class="clear"></div>
