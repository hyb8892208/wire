...
?>
	...
	<form enctype="multipart/form-data" action="<?php echo get_self(); ?>" method="post">
		...
		<div class="content">
			<span class="title"><?php echo language('SimEmu Logs Settings');?></span>
					...
					<div class="tip_main">
						...
						<div class="tip_help">
							...
							<div class="tip_content">
								<b><?php echo 'SimEmu '.language('Auto clean');?>:</b><br/>
			...
			<div class="tab_item">
				<span>
					...
					<div class="tip_main">
						...
						<div class="tip_help">
							...
							<div class="tip_content">
								<b><?php echo language('Log_class');?>:</b><br/>
				...
				<div class="tab_item_right">
					...
					<div style="float:left;margin-right:30px;">
						<input type="checkbox" name="info" <?php if($emu_log_class == 1 || $emu_log_class == 3 || $emu_log_class == 5 || $emu_log_class == 7)echo 'checked';?>/>
					</div>
					<span style="float:left;margin:5px;"><?php echo language('Warning');?>:</span>
					<div style="float:left;margin-right:30px;">
						<input type="checkbox" name="warning" <?php if($emu_log_class == 2 || $emu_log_class == 3 || $emu_log_class == 6 || $emu_log_class == 7)echo 'checked';?>/>
					</div>
					<span style="float:left;margin:5px;"><?php echo language('Error');?>:</span>
					<div style="float:left;margin-right:30px;">
						<input type="checkbox" name="error" <?php if($emu_log_class == 4 || $emu_log_class == 5 || $emu_log_class == 6 || $emu_log_class == 7)echo 'checked';?>/>
					</div>
				</div>
			</div>
				...
				<span>
					...
					<div class="tip_main">
						...
						<div class="tip_help">
							...
							<div class="tip_content">
								<b><?php echo language('USB data Logs');?>:</b><br/>
		...
		<div class="content">
			<span class="title"><?php echo language('SimEmu Logs');?></span>
