...
?>
	<div class="content">
			...
			<div class="tip_main">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						...
						<?php if(is_show_language_help('Fixed Time Call')){ ?>
							<b><?php echo language('Fixed Time Call')?>:</b><br/>
							<?php echo language('Fixed Time Call help','Fixed Time Call');?>
						<?php } ?>
						
						<?php if(is_show_language_help('Fixed Time Call Type')){ ?>
							<b><?php echo language('Fixed Time Call Type')?>:</b><br/>
							<?php echo language('Fixed Time Call Type help','Fixed Time Call Type');?>
						<?php } ?>
						
						<?php if(is_show_language_help('Next Call Time')){ ?>
							<b><?php echo language('Next Call Time');?>:</b><br/>
							<?php echo language('Next Call Time help','Next Call Time');?>
						<?php } ?>
						
						<?php if(is_show_language_help('Setup Period')){ ?>
							<b><?php echo language('Setup Period');?>:</b><br/>
							<?php echo language('Setup Period help','Setup Period');?>
						<?php } ?>
						
						<?php if(is_show_language_help('Call Max Time')){ ?>
							<b><?php echo language('Call Max Time');?>:</b><br/>
							<?php echo language('Call Max Time help','Call Max Time');?>
						<?php } ?>
						
						<?php if(is_show_language_help('Call Min Time')){ ?>
							<b><?php echo language('Call Min Time');?>:</b><br/>
		...
		<div class="callmonitor_switch_show">
			<div class="tab_item">
				<span>
			...
			<div class="tab_item fixed_time_call_show">
				<span>
					<?php echo language('Fixed Time Call Type')?>:
				</span>
				<div class="tab_item_right">
					<select name="fixed_time_call_type" id="fixed_time_call_type">
						<option value="day" <?php if($fixed_time_call_type == 'day') echo 'select';?>>1 <?php echo language('Day');?></option>
						<option value="2day" <?php if($fixed_time_call_type == '2day') echo 'select';?>>2 <?php echo language('Day');?></option>
						<option value="3day" <?php if($fixed_time_call_type == '3day') echo 'select';?>>3 <?php echo language('Day');?></option>
						<option value="4day" <?php if($fixed_time_call_type == '4day') echo 'select';?>>4 <?php echo language('Day');?></option>
						<option value="5day" <?php if($fixed_time_call_type == '5day') echo 'select';?>>5 <?php echo language('Day');?></option>
						<option value="week" <?php if($fixed_time_call_type == 'week') echo 'select';?>>1 <?php echo language('Week');?></option>
						<option value="month" <?php if($fixed_time_call_type == 'month') echo 'select';?>>1 <?php echo language('Month');?></option>
					</select>
				</div>
			</div>
			...
			<div class="tab_item fixed_time_call_show">
				...
				<div class="tab_item_right">
					<span id="cfixed_time_calltime" style="margin-left:10px;"></span>
	...
	<div class="content">
		<table class="table_show callmonitor_switch_show">
...
?>
	...
	<div id="button_save">
		<?php if(!$only_view){ ?>
		<button type="submit" id="sendlabel" onclick="document.getElementById('send').value='Save';return check();"><?php echo language('Save');?></button>
		<?php } ?>
