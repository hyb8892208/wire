	...
	<div class="content">
				...
				<div class="tip_help">
					...
					<div class="tip_content">
						<?php if(is_show_language_help('Query Swith')){ ?>
							...
							<?php echo language('Query Swith help','After opening, the balance can be queried.');?>
						...
						<?php if(is_show_language_help('Matching Key')){ ?>
							...
							<?php echo language('Matching Key help','The first 10 words in the contents of the content returned by the operator are not more than 30 words.'); ?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Registered Query')){ ?>
							<b><?php echo language('Registered Query');?>:</b><br/>
							<?php echo language('Registered Query help','SIM Card Registration Successful Automatic Query Once.'); ?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Interval')){ ?>
							<b><?php echo language('Interval');?>:</b><br/>
							<?php echo language('Interval help','Interval range:0-30000.When the value is 0, it is closed.<br/>Unit: Minute.'); ?>

							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Call Count Query')){ ?>
							<b><?php echo language('Call Count Query');?>:</b><br/>
							<?php echo language('Call Count Query help','Call Count Query range:0-100.When the value is 0, it is closed.'); ?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Decimal mark')){ ?>
							<b><?php echo language('Decimal mark');?>:</b><br/>
							<?php echo language('Decimal mark help','Operators reply to decimal point symbols of numerical content'); ?>
							
							<br/><br/>
						<?php } ?>
						
						<?php if(is_show_language_help('Kilo mark')){ ?>
							<b><?php echo language('Kilo mark');?>:</b><br/>
							<?php echo language('Kilo mark help','Operator responds to the microbit symbol of numeric content'); ?>
						<?php } ?>
					</div>
				</div>
			</div>
		...
		<div class="tab_item">
			...
			<div class="tab_item_right">
				...
				<input type="text" name="interval" id="interval" value="<?php echo $interval; ?>" 
				oninput="this.value=this.value.replace(/[^\d]*/g,'')" onkeyup="this.value=this.value.replace(/[^\d]*/g,'')" />
			</div>
		</div>
...
function save_balance(){
	...
	save_user_record("","ADVANCED->Balance:Save,channel=".$channel);
