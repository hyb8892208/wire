...
?>
	<table width="100%" cellpadding="0" cellspacing="0" class="tedit_tab">
		<tr>
			...
			<td width="28%"><?php echo language('Call Forwarding Unconditional');?></td>
			<td width="42%">
		...
		<tr>
			...
			<td colspan=2 width="50%"><?php echo language('Cancel All');?></td>
	...
	<table width="100%" class="tshow" >
		<tr>
			...
			<th style="width: 70%;padding-left:0;">
				<table width="100%" cellpadding="0" cellspacing="0" class="tshow" style="border:none;">
					<tr>
						<th width="20%" align="center"><?php echo language('Select');?></th>
						<th width="28%"><?php echo language('Call Type');?></th>
						<th width="42%"><?php echo language('Call Number');?></th>
						<th width="30%"><?php echo language('Status');?></th>
					</tr>
				</table>
			</th>
		</tr>
