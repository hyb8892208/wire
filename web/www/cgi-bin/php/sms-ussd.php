...
<form enctype="multipart/form-data" action="<?php echo get_self() ?>" method="post">
	<div id="tab" style="height:30px;">
		<li class="tb1">&nbsp;</li>
		<li class="tbg"><?php echo language('HTTP to USSD');?></li>
		<li class="tb2">&nbsp;</li>
	</div>
	...
	<div width="100%" class="div_tab"  id="div_tab">
		...
		<div class="div_tab_hide" id='http_api_gen' >
			<div class="div_tab_th">
				<div class="helptooltips">
			...
			<div class="div_tab_th">
				<div class="helptooltips">
					...
					<span class="showhelp">
					<?php 
						echo language('HTTP to USSD URL help','
			...
			<div class="div_tab_td"  id="div_tab_td">
				<div class="div_tab_text">
					...
					<button style="
						...
						border: 1px;" 
					type="button" id="http_to_sms_help" title="Usage of HTTP to USSD">
	...
	?>
			...
			<div class="div_tab_th">
				<div class="helptooltips">
					...
					<span class="showhelp">
						<?php echo language('HTTP to USSD Report help', 'USSD send result Report');?>
					</span>
				</div>
			</div>
			<div class="div_tab_td"  id="div_tab_td">
	...
	<div id="tab" style="height:30px;">
		<li class="tb1">&nbsp;</li>
		<li class="tbg"><?php echo language('USSD Result');?></li>
		<li class="tb2">&nbsp;</li>
	</div>
		...
		<div class="div_tab_sms_hide" id="sms_api_gen">
			<div class="div_tab_th" style="">
				<div class="helptooltips">
					...
					<span class="showhelp">
						<?php echo language('USSD to HTTP URL help', 'The USSD receive HTTP URL'); ?>
					</span>
				</div>
			</div>
			<div class="div_tab_td"  id="div_tab_td">
				<select name="url_http" id="url_http">
				...
				<button style="
					...
					background-color: #e8eff7;
					border: 1px;" 
				type="button" id="sms_to_http_help" title="Usage of USSD to HTTP">
					<img src="/images/help.png">
				</button>
			</div>
		</div>
