...
<br />
	<div class="top-button">
		...
		<button type="button " class="ant-btn ant-btn-primary next">
			<span class="get-page"><?php echo language('Next');?></span>
		</button>
		
		<?php if($__demo_enable__ != 'on'){ ?>
...
<div class="section-foot">	
		Copyright © 2019 OpenVox All Rights Reserved.     TEL:+86-755-82535461 FAX:+86-755-83823074
	</div>
</body>
<script type="text/javascript">
...
$(function(){
	...
	$(".save").click(function(){
		...
		setTimeout(function(){window.location.href="http://"+all_data['lan_ip_address'];},1000);
	}); 
