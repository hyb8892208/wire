...
<div class="ant-card-body" data-for="four-page" style="padding: 20px;display:none">
	<div class="ant-row">
		<div class="ant-col-24">
			<div class="section-title"><span>Sip Endpoint</span></div>
		</div>
	</div>
    ...
    <div class="content">
      ...
      <span style="color: rgb(170, 170, 170);">3. <?php echo language('Client mode', 'Client: Acts as a SIP Client, the gateway sends registration to SIP servers.')?></span><br>
    </div>
  </div>
</div>
